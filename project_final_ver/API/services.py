...
class FileProcessingService:
    ...
    async def create_job(self) -> str:
        ...
        await self.repository.create(job_id)
        return job_id
    ...
    async def process_pipeline(
        ...
        try:
            ...
            await self.repository.set_completed(job_id, ai_insights)

        except Exception as e:
            await self.repository.set_failed(job_id, f"Erreur durant le traitement : {str(e)}")
    ...
    async def get_job_status(self, job_id: str) -> ResultResponse:
